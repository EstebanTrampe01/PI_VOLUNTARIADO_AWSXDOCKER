...
func main() {
	...
	go pollRam("/proc/ram_202200314", InforamChan, time.Second*5)
	go pollCpu("/proc/cpu_202200314", InfoCpuChan, time.Second*5)
	go pollProcesos("/proc/procesos_202200314", InfoProcChan, time.Second*5)
